...
var NewAircraftComponent = /** @class */ (function () {
    function NewAircraftComponent(adminService, route) {
        this.adminService = adminService;
        this.route = route;
        this.takeOffList = [];
        this.landingList = [];
    ...
    NewAircraftComponent.prototype.addTakeOff = function () {
        ...
        var takeOff = { id: this.takeOffCount, density: '0', ground_roll: '0', obstacle: '0' };
        this.takeOffList.push(takeOff);
    };
    NewAircraftComponent.prototype.addLanding = function () {
        this.landingCount = this.landingCount + 1;
        var landing = { id: this.landingCount, density: '0', ground_roll: '0', obstacle: '0' };
